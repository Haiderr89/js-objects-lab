...
*/
for(let evolve of game.party){
  if (evolve.starter === true) {
...
*/
for(let name of pokemon){
  if (name.starter === true) {
    console.log(name.name);
  }
}
// ----------------------------------------------------
